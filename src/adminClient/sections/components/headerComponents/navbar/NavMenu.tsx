            ...
            <div>
                ...
                <Menu open={Boolean(anchorEl)}
                    ...
                    <MenuItem onClick={handleClose}><Link className={[classes.navBarMenuColor, classes.linkDecoration].join('')} style={{ textDecoration: 'none', color: 'inherit' }} to="/home"><HomeIcon
                      ...
                      <MenuItem onClick={handleClose}><Link className={[classes.navBarMenuColor, classes.linkDecoration].join('')} style={{ textDecoration: 'none', color: 'inherit' }} to="/acceptUsers"><HomeIcon
                        style={{color: "#C1C4C8", marginRight: 6}}/>Accept Users</Link></MenuItem>
                    <MenuItem onClick={handleClose}><Link className={[classes.navBarMenuColor, classes.linkDecoration].join('')} style={{ textDecoration: 'none', color: 'inherit' }} to="/searchOrAddUser"><SearchIcon
                        style={{color: "#C1C4C8", marginRight: 6}}/>Search or Add Users</Link></MenuItem>
                    ...
                    <MenuItem onClick={handleClose}><Link className={[classes.navBarMenuColor, classes.linkDecoration].join('')} style={{ textDecoration: 'none', color: 'inherit' }} to="/editOrDeleteUser"> <FavoriteIcon
                        style={{color: "#C1C4C8", marginRight: 6}}/> Edit or Delete Users</Link> </MenuItem>

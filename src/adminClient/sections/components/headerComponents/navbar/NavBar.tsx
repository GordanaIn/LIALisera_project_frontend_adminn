            ...
            <AppBar position="static" color={"primary"} variant={"outlined"} className={classes.appBar}>
                <Toolbar>
                    ...
                    <Grid container direction="row" justify="center" alignItems="center">
                        ...
                        <Grid item className={classes.grid}>
                            {checkWindowSize !== false ?
                                <Link className={classes.linkDecoration} to="/acceptUser" > Accept Users</Link> :null}
                        </Grid>
                        <Grid item className={classes.grid}>
                            {checkWindowSize !== false ?
                                <Link className={classes.linkDecoration} to="/searchOrAddUser" > Search or Add User </Link> :null}
                        </Grid>
                        <Grid item className={classes.grid}>
                            {checkWindowSize !== false ?
                                <Link className={classes.linkDecoration} to="/editOrDeleteUser" > Edit or Delete User </Link> :null}
                        </Grid>
                        <Grid item className={classes.grid}>
                            {checkWindowSize !== false ?
